...
def load_all_payruns(headers):
    ...
    while True:
        ...
        page_count = pagination.get(
            "pageCount",
            1
        )

        print(
            f"Loaded payrun page "
            f"{page} of {page_count}"
        )
...
def callback():
    ...
    for _, row in df.iterrows():
        ...
        try:
            ...
            employee_end_date = employee.get(
                "endDate"
            )
